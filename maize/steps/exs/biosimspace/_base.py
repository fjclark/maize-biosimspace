...
from maize.core.interface import FileParameter, Input, Output, Parameter
...
class _BioSimSpaceBase(Node, ABC):
    ...
    # Output
    out: Output[list[Path]] = Output(mode="copy", optional=True)
    ...
    def _save_output(
        ...
        if self.save_name.is_set:
            ...
            BSS.IO.saveMolecules(file_base, system, ["gro87", "grotop"])
